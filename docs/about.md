...
Before, he studied in Karlsruhe, KIT, where he was working with the [Institute for Technology and Management in Construction](https://www.tmb.kit.edu/FM_Mitarbeiter_3907.php){target=_blank} to create a benchmarking platform for technical management in hospitals ([OPIK](https://opik.tmb.kit.edu){target=_blank}) and lift it into cyber space.
